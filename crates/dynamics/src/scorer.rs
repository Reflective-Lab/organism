...
/// Hex-encode `draft_batch_id` for use in fact ids. Mirrors the
/// critic's encoding so consumers can match fact ids deterministically
/// without worrying about disallowed characters.
...
fn decode_batch_id(encoded: &str) -> Option<String> {
