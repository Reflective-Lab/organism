...
- **Spec:** `~/dev/reflective/bedrock-platform/organism/kb/Concepts/Bidirectional ExperienceStore.md`
- **Existing pattern:** `~/dev/reflective/bedrock-platform/converge/crates/core/src/recall.rs` lines 617-655 (`record_to_candidate`)
- **First Organism consumer:** `~/dev/reflective/bedrock-platform/organism/crates/runtime/tests/recall_biases_synthesis.rs` (already exercises the two landed variants)
